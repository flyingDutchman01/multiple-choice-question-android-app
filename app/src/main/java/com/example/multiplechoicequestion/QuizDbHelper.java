...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable(){
        ...
        Question q3 = new Question("विश्व इतिहासमा रक्तहिन क्रान्तिका नामले चिनिने क्रान्ति कुन हो ? ","भारतीय स्वतन्त्रता संग्राम","फ्रान्सेली राज्य क्रान्ति","रसियन अक","वेलायतको गौरवमय क्रान्ति  ",4);
        addQuestion(q3);
        ...
        Question q5 = new Question("कलाकार वासुदेव मुनालको निधन कहिले भयो ? ","२०७४ असोज १०","२०७४ असोज १२","२०७४ असोज १","२०७४ असोज १४",2);
        addQuestion(q5);
        ...
        Question q9 = new Question("कोत पर्वमा सर्वप्रथम मारिने अभिमानसिंहलाई कसले मारेका थिए ?","जंगबहादुर राणा","युद्धवीर अधिकारी","अन्नत पाण्ड","कनन सिंह",2);
        addQuestion(q9);

        Question q10 = new Question("10.उजुरी पेटिकाको ब्यवस्था गर्ने राणा प्रधानमन्त्री को हुन् ?  ","वीर शमशेर","देव शमशेर","चन्द्र शमशेर","जुद्ध शमशेर",2);
        addQuestion(q10);

        Question q11 = new Question("टोलेमी (Plodemy) राजाहरुको कुन देशमा राज्य गर्दथे ?","सिरिया","प्यालेस्टाइन","इजिप्ट","मोरक्को",3);
        addQuestion(q11);

        Question q12 = new Question("2015 सालको निर्वाचनमा निर्वाचित हुने एक मात्र महिला प्रतिनिधि को हुन् ?","सहानादेवी प्रधान","द्वारिकादेवी ठकुरानी","भद्रा कुमारी घले","शैलजा आचार्य ",2);
        addQuestion(q12);

        Question q13 = new Question("13.यहाङ्ग विभिन्न कालका प्रथम राजाहरुको नाम दिइएका छन् । 1. अरिदेव मल्ल\t2. भक्तमान\t3. जयदेव\t\t4. बरसिंह\n" +
                "कालखण्डका आधारमा पहिलोदेखि अन्तिम क्रममा मिलाउनुहोस् ।","2,3,4,1","1,2,3,4","2,1,4,3","2,4,3,1",4);
        addQuestion(q13);
        ...
        Question q17 = new Question("17.प्रधानमन्त्रीहरुको क्रम मिलाउनुहोस् । 1. पुष्कर शाह\t2. भिमसेन थापा\t3. रणजङ्ग पाण्डे\t4. रंगनाथ पौडेल\t5. माथवरसिंह थापा  ","2,4,1,3,5","2,1,4,5,3","2,4,3,1,5","2,4,5,3,1",1);
        addQuestion(q17);
        ...
        Question q19 = new Question("19.प्रथम विश्व युद्धको क्रममा कति जना नेपालीले भिक्टोरिया क्रस प्राप्त गरेका थिए ?  ","1 जना","2 जना","3 जना","1 जना",2);
        addQuestion(q19);
